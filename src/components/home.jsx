    ...
    <>
      <div className="home">
        <div className="hello-img">
          <img
            src={require("../static-img/articles/retro.jpg")}
            width={"100%"}
            alt=""
          />
          <Link to={"/article"}>
        ...
        <div className="container-2">
          ...
          <div className="blocks">
            <div className="item"><img src={require('../static-img/box/jacket.jpg')} alt="" /> <div className="title">куртки</div></div>
            <div className="item"><img src={require('../static-img/box/sneakers.jpg')} alt="" /> <div className="title">обувь</div></div>
            <div className="item"><img src={require('../static-img/box/hoodies.jpg')} alt="" /> <div className="title">худи</div></div>
