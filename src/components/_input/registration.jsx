      ...
      <div className="register" id='box' >
        ...
        if (width <= 723 && width >=250) {
          ...
          <div className="header">
              ...
              <div className="input-container">
            <label>Имя</label>
            <input type="text" name="name" placeholder="Имя"  autoSave='true' defaultValue={mail} onChange={(el)=>{(setMail(el.target.value))}}  required  />
  
     
          </div>
          <div className="input-container">
            <label>Фамилия</label>
            <input type="text" name="name" placeholder="Фамилия"  id='input' autoSave='true' defaultValue={mail} onChange={(el)=>{(setMail(el.target.value))}}  required   />
